...
const faqs = [
  {
    ...
    answer: "Internet Core is managed by ZA LOGISTICS INC, an independent marketing partner. We are not the official site of any specific internet or cable provider.",
  },
  {
  ...
  },
  {
    ...
    answer: "Payments are made directly to the service provider. Internet Core does not handle payments for services. However, ZA LOGISTICS INC may charge a separate service and setup fee for coordinating your order.",
  },
  {
