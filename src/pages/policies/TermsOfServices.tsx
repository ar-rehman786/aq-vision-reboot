              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    by these Terms & Conditions. The Website is owned and operated by ZA LOGISTICS INC, 
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ZA LOGISTICS INC charges a separate service and setup fee for processing and 
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-muted/50 rounded-xl p-6 space-y-2">
                    ...
                    <p className="text-muted-foreground">ZA LOGISTICS INC</p>
